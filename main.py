...
def lucaskanade(im1, im2, N):
    ...
    #TODO HARRIS
    #corner = cv2.cornerHarris(dx, neigh, 3, 0.05)
    #plt.imshow(corner)
    #plt.show()
...
def hornschunck(im1, im2, n_iters, lmbd, initial=False):
    # im1 − f i r s t image mat rix ( g r a y s c a l e )
